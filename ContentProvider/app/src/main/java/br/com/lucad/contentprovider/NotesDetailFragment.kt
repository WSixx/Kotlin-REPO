...
import br.com.lucad.contentprovider.database.NotesDatabaseHelper.Companion.DESCRIPTION_NOTES
import br.com.lucad.contentprovider.database.NotesDatabaseHelper.Companion.TITLE_NOTES
import br.com.lucad.contentprovider.database.NotesProvider.Companion.URI_NOTES
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        if(arguments != null && arguments?.getLong(EXTRA_ID) != 0L){
            ...
            if(cursor?.moveToNext() as Boolean){
                ...
                noteEditTitle.setText(cursor.getString(cursor.getColumnIndex(DESCRIPTION_NOTES)))
            }
            cursor.close()
        }
