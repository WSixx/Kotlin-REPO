...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        grid_view_foods.adapter =adapter
    ...
    class  FoodAdapter: BaseAdapter {
        ...
        override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View {
            ...
            foodView.image_view_food.setImageResource(food.image)
            foodView.image_view_food.setOnClickListener {
            ...
            foodView.text_view_title.text =  food.name
            return  foodView
